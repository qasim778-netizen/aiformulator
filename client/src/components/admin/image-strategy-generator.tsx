      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-amber-50 p-4 rounded-lg border border-amber-200 space-y-3">
            <h4 className="font-semibold text-sm text-amber-900">📋 3 Strategy Images:</h4>
            <div className="space-y-2 text-sm text-amber-800">
              ...
              <p><strong>Image 2 — How It Works Process:</strong> 3-4 step application/usage diagram with category-specific steps</p>
              <p><strong>Image 3 — Manufacturing Flow:</strong> 3-5 step manufacturing process adapted to product type</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-green-50 rounded-lg border border-green-200">
              ...
              {generatedImages.image2Url && (
                <div className="space-y-2">
                  ...
                  <img src={generatedImages.image2Url} alt="Process" className="w-full h-auto rounded border" />
                </div>
              )}
              {generatedImages.image3Url && (
                <div className="space-y-2">
                  <h4 className="font-semibold text-sm text-green-900">✓ Manufacturing Flow</h4>
                  <img src={generatedImages.image3Url} alt="Manufacturing" className="w-full h-auto rounded border" />
                </div>
              )}
            </div>
          )}
