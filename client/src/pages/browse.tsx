              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                  <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
                    Browse Chemical Formulations
                  </h1>
                  <h2 className="text-xl sm:text-2xl text-gray-600 mb-3">
                    Professional Ready-to-Use Formulas for Small Business Manufacturers
                  </h2>
                  <p className="text-base sm:text-lg text-gray-600 mb-4 max-w-3xl mx-auto">
                    Access 137+ professionally tested formulations across 22 product categories. 
                    Complete documentation, detailed instructions, and ingredient specifications included.
                  </p>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center p-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900 mb-2">Tested Formulations</h2>
                  ...
                  <div className="text-center p-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900 mb-2">Fast Production</h2>
                    <p className="text-gray-600">
                  ...
                  <div className="text-center p-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900 mb-2">Complete Documentation</h2>
                    <p className="text-gray-600">
