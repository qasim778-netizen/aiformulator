...
export default function Browse() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <section id="custom-formulation" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {!isWizardActive && (
            <div className="text-center mb-8">
              <h2 className="text-3xl font-inter font-bold text-gray-900 mb-4">Need Something Custom?</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
                Can't find the exact formulation you need? Create a custom formula tailored to your specific requirements with our AI-powered wizard.
              </p>
              <div className="flex justify-center">
                <Card className="max-w-md w-full cursor-pointer transition-all duration-300 hover:shadow-xl hover:scale-[1.02] ring-2 ring-primary bg-primary/5 border-primary">
                  <CardContent className="p-6 text-center">
                    <div className="bg-gradient-to-br from-purple-500 to-pink-500 text-white p-4 rounded-xl w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-lg">
                      <Sparkles className="h-8 w-8" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Create Custom Formula</h3>
                    <p className="text-gray-600">AI-powered formulation wizard with precise specifications</p>
                  </CardContent>
                </Card>
              </div>
            </div>
