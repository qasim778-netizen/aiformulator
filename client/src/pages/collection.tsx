      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-6 p-6 sm:p-6 lg:p-8">
          ...
          <div ref={contentRef} className="flex-1 flex flex-col min-w-0">
            ...
            {/* TOP CTA */}
            <a href="/" className="block mb-6 flex-shrink-0 rounded-2xl overflow-hidden group" style={{ textDecoration: "none" }}>
            ...
            {/* BOTTOM CTA */}
            {!formulationsLoading && (
              <a href="/" className="block mt-8 flex-shrink-0 rounded-2xl overflow-hidden group" style={{ textDecoration: "none" }}>
