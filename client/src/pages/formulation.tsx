              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    ...
                    data-testid="button-share-formula"
                  >
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuItem
                    onClick={() => window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent(formulation?.name || 'Check out this formula')}`, '_blank')}
                    className="cursor-pointer gap-2"
                  >
                  ...
                  <DropdownMenuItem
                    onClick={() => window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent((formulation?.name || 'Check out this formula') + ' ' + window.location.href)}`, '_blank')}
                    className="cursor-pointer gap-2"
                  >
                  ...
                  <DropdownMenuItem
                    onClick={() => {
                      ...
                      toast({ title: "Link copied!", description: "Share it on Instagram or anywhere else." });
                    }}
                    className="cursor-pointer gap-2"
                  >
