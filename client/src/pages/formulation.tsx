  ...
  return (
    <div className="bg-white py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <a href="https://app.aiformulator.net" target="_blank" rel="noopener noreferrer" className="block my-4 group" style={{ textDecoration: "none" }}>
        ...
        <Card className="bg-white rounded-lg shadow-lg border border-gray-200">
          <CardContent className="p-8">
            ...
            <a href="https://app.aiformulator.net" target="_blank" rel="noopener noreferrer" className="block mb-6 group" style={{ textDecoration: "none" }}>
