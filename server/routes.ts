...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.get('/api/admin/user-formulations/:id/generated', requireAdmin, async (req: any, res) => {
    try {
      ...
      // Get all formulations (both the specific one linked and any others generated by session/user)
      const allFormulations = await storage.getAllFormulations();
      
      // Filter formulations - return the one linked to this request, plus any others with matching session/user
